...
class __TwigTemplate_67ae2031fa36878ce6a67693649948cd38d8b3c4ccb60216043bb2d31f63dd63 extends Template
{
    private $source;
    private $macros = [];
...
<p>";
        // line 6
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["article"]) || array_key_exists("article", $context) ? $context["article"] : (function () { throw new RuntimeError('Variable "article" does not exist.', 6, $this->source); })()), "body", [], "any", false, false, false, 6), "html", null, true);
        echo "</p>
<hr>
<a href=\"/symphart/public\">Go Back</a>
";
    ...
    {
        return array (  78 => 6,  73 => 5,  66 => 4,  53 => 2,  36 => 1,);
    }
...
<hr>
<a href=\"/symphart/public\">Go Back</a>
{% endblock %}", "articles/show.html.twig", "/opt/lampp/htdocs/symphart/templates/articles/show.html.twig");
    }
}
